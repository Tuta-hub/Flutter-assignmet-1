          ...
          Card(
            ...
            child: Row(
              ...
              children: [
                ...
                Icon(Icons.arrow_forward_ios, color: Colors.red, size: 21),
              ],
            ),
          ),
          Card(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 40),
                          Icon(Icons.shopping_cart_outlined, color: Colors.grey, size: 15),
                          SizedBox(width: 10),
                          Icon(Icons.refresh, color: Colors.grey, size: 15),
                          SizedBox(width: 10),
                          Icon(Icons.favorite_border_outlined, color: Colors.grey, size: 15),
                          SizedBox(width: 10),
                        ],
                      ),
                    ]
                    ...
                    Stack(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Image.asset('air-zoom.jpg',
                              width: 150),
                        ),
                      ],
                    ),
